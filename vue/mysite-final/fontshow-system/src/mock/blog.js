...
Mock.mock("/api/blogtype", "get", {
    ...
    "data|16-23": [{
        "id|+1": 1,
        "name|+1": ['数据结构', '数据库', 'JavaScript', 'HTML', 'CSS', 'VUE', 'REACT',
            'bootstrap', '算法', 'GIT', 'ES6', 'DOM', '浏览器', 'java', 'C语言',
            '网络编程', 'Linux', '操作系统', 'UML', '计算机组成原理', '计算机网络', '人机交互', '编译原理'
        ],
    ...
    return Mock.mock({
        ...
        data: {
            ...
            [`rows|${url.limit||10}`]: [{
                ...
                "thumb|1": ["@image('300x250',@color,@color,Random)", null],
                createDate: `@date('T')`,
            }]
        }
    })
