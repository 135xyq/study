    ...
    <!-- 表格组件 -->
		<div class="article-table-container">
			...
			>
				...
				>
					<template slot-scope="scope">
						<el-button size="mini" type="primary" @click="onHandleEdit(scope)">编辑</el-button>
						<el-button size="mini" type="danger" @click="onHandleDelete(scope)">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
		</div>
...
export default {
    ...
    async onHandleEdit(scope){
      ...
      this.$router.push({name:'ArticleEdit',query:{data:data,articleId}})
    },
    // 删除文章
